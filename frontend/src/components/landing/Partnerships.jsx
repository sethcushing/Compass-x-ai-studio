            ...
            return (
              ...
              >
                <CardContent className="p-5 text-center">
                  <div className="w-12 h-12 rounded-xl bg-sky-50 flex items-center justify-center mx-auto mb-3 group-hover:bg-sky-100" style={{ transition: 'background-color 0.2s ease' }}>
